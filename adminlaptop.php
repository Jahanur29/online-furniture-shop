...
<header id="header"><!--header-->
					...
					<div class="col-sm-6">
						<div class="contactinfo">
							<ul class="nav nav-pills">
								<li><a href="#"><i class="fa fa-phone"></i> +8801620418419</a></li>
								<li><a href="#"><i class="fa fa-envelope"></i> shaonn33@gmail.com</a></li>
							</ul>
						</div>
					</div>
					<div class="col-sm-6">
    ...
    <div class="col-sm-9 padding-right">
					<div class="features_items"><!--features_items-->
						<h2 class="title text-center">WOMENS Product</h2>
